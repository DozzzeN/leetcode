...
public class construct_a_multiplication_array {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new construct_a_multiplication_array.Solution().multiply(
                new int[]{1, 2, 3, 4, 5}
        )));
        System.out.println(Arrays.toString(new construct_a_multiplication_array.Solution().multiply2(
                new int[]{1, 2, 3, 4, 5}
        )));
    }
